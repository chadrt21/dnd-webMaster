...
(weaponPropertyName, weaponPropertyDesc)
VALUES
...
('Special', 'A weapon with the special property has unusual rules governing its use, explained in the weaponâ€™s description (see â€œSpecial Weaponsâ€� later in this section).'),
...
('Monk', 'Monks gain several benefits while unarmed or weilding only monk weapons while they aren\'t wearing armor or wielding shields.')
