...
('Special', 'A weapon with the special property has unusual rules governing its use, explained in the weapon\'s description (see â€œSpecial Weaponsâ€� later in this section).'),
